<%@ Page Title="" Language="C#" MasterPageFile="~/Visitor/visitormaster.master" AutoEventWireup="true" CodeFile="Register1.aspx.cs" Inherits="Visitor_Register1" %>
        ...
        <tr>
            ...
            <td class="style24">
                <asp:TextBox ID="txtname" runat="server" Height="30px" Width="200px" 
                    CssClass="style16" ontextchanged="txtname_TextChanged"></asp:TextBox>
                <br />
            </td>
            <td class="style18">
            ...
            <td>
                <asp:TextBox ID="txtage" runat="server" Height="30px" Width="200px" 
                    CssClass="style16" ontextchanged="txtage_TextChanged"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="style26">
            ...
            <td class="style15">
                <asp:TextBox 
                    ID="txtcity" runat="server" Height="30px" Width="200px" CssClass="style16" 
        ...
        <tr>
            ...
            <td class="style24">
                <asp:TextBox ID="txtmobile" 
                    runat="server" Height="30px" Width="200px" CssClass="style16" 
            ...
            <td>
                <asp:TextBox ID="txtemail" runat="server" Height="30px" Width="200px" 
                    CssClass="style16" ontextchanged="txtemail_TextChanged"></asp:TextBox>
